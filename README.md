...
- [ ] What is React JS and what problems does it try and solve? Support your answer with concepts   introduced in class and from your personal research on the web.
      React JS is a library, also considered a framework, designed for buiilding User Interfaces.  React uses a Virtual Dom and by design empowers you to fracture your code base into reusable components.  This allows for more focused development/rendering and easier troubleshooting as it better isolates where issues might be coming from.

- [ ] What does it mean to _think_ in react?
      I believe to 'think' in react means to understand how the tree/inheritence design within react would impact the design of your application.  Understanding where to place content is critical to ensuring each component has access to the necessary content based on the components purpose within the app.

- [ ] Describe state.
      State, to me, is an object that is the final representation of changing data being displayed in the UI within an application.

- [ ] Describe props.
      I believe, in our use of 'render' props, to be a technique for which object properties/code is moved between component files for use within other component files.
