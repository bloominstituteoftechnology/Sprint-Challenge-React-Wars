...
- React is a library for creating interactive UIs. It uses components, DOM manipulation. It doesn't require reloading your browser to change pages or update components.
