...
React JS is a JavaScript library, and it attempts to try to simplify building user interfaces. 

- [ ] What does it mean to _think_ in react?

You have to think in ways of components and how things can be encapsulated. 
...
Objects that can be passed to state. Props are always objects.
