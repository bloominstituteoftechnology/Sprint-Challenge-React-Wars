...
React JS is basically an open sourced javascript library that makes our life easier, we should use it because it offers simplicity, easy to learn, data binding and makes building apps and testing them out faster than most other stuff.
- [ ] What does it mean to _think_ in react?
It means thinking about how react works, looking at a site, breaking it down into components and how everything would work togehter.
- [ ] Describe state.
State is an object that determins how that component renders and behaves.
- [ ] Describe props.
it allows us to pass information to a Component
## Project Set Up
