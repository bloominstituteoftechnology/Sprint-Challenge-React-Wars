        ...
        <div className="container-fluid">        
            <Card className="mein-card"> 
                <CardBody className="row">
                    ...
                    <CardSubtitle className="mt-5 col-12"> {props.rotation_period} </CardSubtitle>
                    <CardText className="bold-card mein-card col-12"> Orbital Period: </CardText>
                    <CardText className="col-12 mt-5"> {props.orbital_period} </CardText>
                    <CardText className="bold-card mein-card col-12"> Diameter: </CardText>
                    <CardText className="col-12 mt-5"> {props.diameter} </CardText>
