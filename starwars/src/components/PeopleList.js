    ...
    return (
        <div className="peopleWrapper">
            {props.array.map((person, index) => {
                return <People name={person.name} birthYear={person.birth_year} gender={person.gender} eyeColor={person.eye_color} films={person.films} height={person.height} mass={person.mass} homeworld={person.homeworld} url={person.url} key={person.name} descriptions={props.array2} index={index} />
            })}
