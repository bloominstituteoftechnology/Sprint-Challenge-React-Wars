...
describe('RTM API Message Handlers: Channel, Group & DM Events', function () {
    ...
    describe('`im_xxx` events', function () {
        ...
        it('sets isOpen to true on a DM channel when an `im_open` message is received', lodash.partial(testDMOpenStatus, true, RTM_API_EVENTS.IM_OPEN));
        it('sets isOpen to false on a DM channel when an `im_close` message is received', lodash.partial(testDMOpenStatus, false, RTM_API_EVENTS.IM_CLOSE));
...
//# sourceMappingURL=channel-group-dm.js.map