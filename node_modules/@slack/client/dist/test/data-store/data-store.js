...
describe('DataStore', function () {
    describe('#handleRtmMessage()', function () {
        var testMessageHandler = function testMessageHandler(eventType, isMsg, optExpectedHandlerType) {
            ...
            dataStore.handleRtmMessage('', '', isMsg ? RTM_EVENTS.MESSAGE : eventType, getRTMMessageFixture(eventType));
        ...
        it('calls the `rtm_client_add_message` handler for msgs with no subtype handler', function () {
            testMessageHandler(makeMessageEventWithSubtype(MSG_SUBTYPES.GROUP_NAME), true, makeMessageEventWithSubtype('rtm_client_add_message'));
        });
    });
});
