...
var defaultHTTPResponseHandler = require('../../../lib/clients/transports/call-transport').handleHttpResponse;
...
describe('Web API Client', function () {
    ...
    it('should add metadata to raw Buffers for files.upload', function (done) {
        ...
        client._makeAPICall('files.upload', { filename: 'train.jpg' }, { file: imageBuffer }, function (error, results) {
