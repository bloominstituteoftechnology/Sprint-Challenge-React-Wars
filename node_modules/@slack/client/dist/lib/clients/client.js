...
function BaseAPIClient(token, opts) {
     ...
     * @private
     */
    this.requestQueue = async.queue(bind(this._callTransport, this), clientOpts.maxRequestConcurrency || 3);
    this._createFacets();
...
BaseAPIClient.prototype._makeAPICall = function _makeAPICall(endpoint, apiArgs, apiOptArgs, optCb) {
    var self = this;
    var apiCallArgs = clientHelpers.getAPICallArgs(self._token, globalHelpers.getVersionString(), self.slackAPIUrl, endpoint, apiArgs, apiOptArgs, optCb);
